...
exe '3resize ' . ((&lines * 26 + 18) / 37)
exe 'vert 3resize ' . ((&columns * 94 + 86) / 173)
argglobal
balt makefile
nmap <buffer> 	 I	
nmap <buffer> <expr> _# ResetComment()
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 530 - ((17 * winheight(0) + 17) / 35)
...
wincmd w
argglobal
if bufexists(fnamemodify("tokenizer.h", ":p")) | buffer tokenizer.h | else | edit tokenizer.h | endif
balt value.h
nmap <buffer> 	 I	
setlocal keymap=
setlocal noarabic
...
118
normal! zo
let s:l = 446 - ((13 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 446
